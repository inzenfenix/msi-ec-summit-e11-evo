...
/* CUSTOM MSI SUMMIT E13 EVO A11MT */
static const char *ALLOWED_FW_SUMMIT_E13[] __initconst = {
    "13P2EMS1.110",
    NULL
};

static struct msi_ec_conf CONF_SUMMIT_E13 __initdata = {
    .allowed_fw = ALLOWED_FW_SUMMIT_E13,
